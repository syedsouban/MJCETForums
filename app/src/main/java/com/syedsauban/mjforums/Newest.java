...
public class Newest extends android.support.v4.app.Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, Bundle savedInstanceState) {
        ...
        a1.add(new FeedClass("What were the worst two minutes of your life?", "asked by Irfan Ahmed", "Mohammed Salman",getString(R.string.answer) , "Intern at Chronology", R.drawable.answer_profile));
        a1.add(new FeedClass("What are the negative effects of getting a high salary?", "asked by Ishaq Qadri", "Amir Khan", getString(R.string.answer2), "Intern at Chronology", R.drawable.answer_profile));
        a1.add(new FeedClass("How does the algorithm of Google Maps work?", "asked by Ajaz", "Souban", getString(R.string.answer3), "Intern at Chronology", R.drawable.answer_profile));
